...
public class SubRegionServiceEndpoint extends BaseGraphDbEndpoint<SubRegion, SubRegionDTO> {

  private final SubRegionService subRegionService;

  public SubRegionServiceEndpoint(SubRegionService subRegionService, BackendConverterV2 converter) {
    super(converter);
  ...
  @Override
  protected SubRegionDTO convertToDto(SubRegion domain, Map<String, Object> context) {
    return getConverter().convertToDto(domain, context);
  }

  @Override
  protected List<SubRegionDTO> convertToDtos(
      Iterable<SubRegion> domains, Map<String, Object> context) {
    return getConverter().convertToDtoSubRegions(domains, context);
  }

  @Override
  protected SubRegion convertToDomain(SubRegionDTO dto, Map<String, Object> context) {
    return getConverter().convertToDomain(dto, context);
  }

  @Override
  protected List<SubRegion> convertToDomains(
      Iterable<SubRegionDTO> dto, Map<String, Object> context) {
